...
{
    private static float BaseChainLightningMult = 1f;
    ...
    private static Dictionary<int, float> UpgradedChainLightning = new Dictionary<int, float>();
    ...
    public static float CurChainLightningMult;
    ...
    public static void UpdateSkillContribution(UpgradeType type, int uniqueID, float value, int level)
    {
        ...
        switch (type)
        {
            case UpgradeType.SkillChainLightning: UpgradedChainLightning[uniqueID] = value; break;
    ...
    {
        CurChainLightningMult = BaseChainLightningMult + UpgradedChainLightning.Values.Sum();
